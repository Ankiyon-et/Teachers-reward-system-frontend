            ...
            <div class="max-w-full overflow-x-auto custom-scrollbar">
              <table class="min-w-full">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                  ...
                  <tr v-if="!ratings.length && !loading">
                    <td
                      colspan="3"
...
import { useTeacherRatings } from "@/composables/useTeacherRatings";
...
const { ratings, loading, error, fetchRatings } =
  useTeacherRatings();
